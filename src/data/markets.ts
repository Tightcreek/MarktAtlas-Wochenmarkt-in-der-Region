...
// Unified market data combining all markets from both files
export const marketsData: Market[] = [
  ...
  // 19-103 markets from existing code
  {
    id: "19",
    name: "Severinshof",
    address: "Severinshof",
  ...
  // Additional markets found in MarketDetail.tsx that were missing from Markets.tsx:
  {
    id: "87",
  ...
  // ... continue pattern for remaining markets with proper IDs
];
